...
// Violeta 4,12,20
    ...
    function Site() {
        ...
        if ($this->logged_dt) {
            ...
            $this->_add_menu_item('top', '', array('site/autoAllNoSync', 'autoAllNoSync'));
    ...
    function show_info() {
        if (!$this->logged_dt) {
            $this->_set_json_output('Faça login');
        } else {
    ...
    function show_recrut() {
        if (!$this->logged_dt) {
            $this->_set_json_output('Façaa login');
        } else {
            $r = new Recrut();
    ...
    function login($id = NULL) {
        ...
        if ($c->exists()) {
            ...
            if ($c->login()) {
                ...
                echo 'login retornou falso';
                echo 'last_login = ' . $c->last_login;
            }
        } else {
...
//        $ping = 1;
//        while ($ping < 4) {
//            $a = $this->curl->get_async('http://www.google.com.br/', array(), $ping);
//            echo 'teste' . $ping . '<br>';
//            var_dump($a);
//            $ping = $ping + 1;
//            flush();
//        }
        ...
        $hosts = array("google.com.br", "terra.com.br", "sega.com");
        $timeout = 15;
        $status = array();
        $sockets = array();
